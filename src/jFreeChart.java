...
public class jFreeChart extends ApplicationFrame {
	 ...
	 */
	private static final long serialVersionUID = -2519667984268422493L;

	public jFreeChart(String applicationTitle, String chartTitle) {
	...
	public static void main(String[] args) {
		jFreeChart chart = new jFreeChart("School Vs Years",
